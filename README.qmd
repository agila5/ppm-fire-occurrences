...
**Please check that all necessary packages (or, at least, `targets`, `tarchetypes`, `piggyback`, and `here`) are installed before going to the next section. You also need a reasonably up-to-date Rstudio version or, at least, a regular installation of `quarto` software.**
